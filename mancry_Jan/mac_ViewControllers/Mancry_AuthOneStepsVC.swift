...
class Mancry_AuthOneStepsVC: Mac_BaseViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    let mancry_progressImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "jdt_25")
    ...
    var mancry_items: [Mancry_AuthOneKYCItem] = []
    var mancry_bottomPicker: Mancry_customselectPopupView?
    var mancry_selectedProvinceId: String?
    ...
    override func viewDidLoad() {
        ...
        self.mac_publiccustomnavView(title: "Personal Information")
        setupUI()
        mancry_getOneStepinitData()
    }
